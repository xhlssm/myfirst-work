...
function withErrorBoundary<T extends object>(Component: React.ComponentType<T>, fallback?: React.ReactNode) {
...
const SelectTrigger = withErrorBoundary(SelectTriggerBase);
...
const SelectContent = withErrorBoundary(SelectContentBase);
